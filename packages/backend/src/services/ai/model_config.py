...
# src/services/ai/model_config.py -> project root (parents[5]).
MODELS_FILE = Path(__file__).resolve().parents[5] / "models.json"
...
def _from_env() -> list[ModelDef]:
    ...
    api_key = settings.gateway_api_key or settings.anthropic_api_key
    return [
